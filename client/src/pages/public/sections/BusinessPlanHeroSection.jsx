...
export default function BusinessPlanHeroSection() {
  return (
    <section className="bp-hero">
      ...
      <div className="container">
        <FadeIn>
          <div className="premium-tag-center">
            <BarChart2 size={14} color="#D4AF37" /> Business Plan
          </div>
          <h1 className="hero-heading">
            The RS Trading <br />
            <span className="text-gradient">Income Plan</span>
          </h1>
          <p className="hero-subtext">
            A meticulously structured 9-level income system designed for maximum
            transparency, fair distribution, and exponential growth.
          </p>
        </FadeIn>
      </div>
      ...
      <style>{`
        .bp-hero {
          ...
          padding: 180px 24px 80px; /* Large top padding to clear the fixed navbar */
          text-align: center;
          overflow: hidden;

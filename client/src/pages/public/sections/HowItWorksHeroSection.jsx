      ...
      <div className="container">
        <FadeIn>
          <div className="premium-tag-center">
            <CheckCircle size={14} color="#D4AF37" /> Simple Steps
          </div>
          ...
          <p className="hero-subtext">
            Start earning in 4 simple steps. No experience required. We provide
            the platform, the tracking, and the payouts — you just build the
            network.
          </p>
        </FadeIn>
      </div>
